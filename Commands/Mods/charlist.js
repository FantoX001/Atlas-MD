module.exports = {
  ...
  start: async (Miku, m, { text, prefix ,modStatus}) => {
    ...
    let sections = [] 
    let chars = ['Atlas MD', 'Power', 'Makima', 'Denji', 'Zero Two', 'Chika' , 'Miku', 'Marin','Ayanokoji','Ruka','Mizuhara','Rem','Sumi','Kaguya','Yumeko','Kurumi','Mai','Yor','Shinbou','Eiko']
    let buttonDesc =[`Set bot character to Atlas MD`, `Set bot character to Power`, `Set bot character to Makima`, `Set bot character to Denji`, `Set bot character to Zero Two`, `Set bot character to Chika`, `Set bot character to Miku`, `Set bot character to Marin`, `Set bot character to Ayanokoji`, `Set bot character to Ruka`, `Set bot character to Mizuhara`, `Set bot character to Rem`, `Set bot character to Sumi`, `Set bot character to Kaguya`, `Set bot character to Yumeko`, `Set bot character to Kurumi`, `Set bot character to Mai`, `Set bot character to Yor`, `Set bot character to Shinbou`, `Set bot character to Eiko`]
